...
const planTrip = function(lineA, start, lineB, finish) {
  const lineN = trainLines.N;
  const secondtLine = trainLines.L;
  const thirdLine = trainLines.six;
...
// const planTrip1 = function(startLine, startStation, endLine, endStation) {
...
// planTrip1(line6, "Grand Central", lineL, "1st");
