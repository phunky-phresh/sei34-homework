...
// * Make sure the stops that are the same for different lines have different names (i.e. 23rd on the N and on
//   the 6 need to be differentiated)
//
let totalStops = 0;

const lineN = [ 'Time Square', '34th', '28th', '23rd', 'Union Square', '8th' ]
const lineL = [ '8th', '6th', 'Union Square', '3rd', '1st']
const lineS = [ 'Grand Central', '33rd', '28th', '23rd', 'Union Square', 'Astor Pl'];
...
console.log(`You must travel through the following stops on the ${ lineName }: ${ stops.join(', ') }` );

return stops;

};

stopsMade( 'lineN', 'Time Square', 'Union Square' );
